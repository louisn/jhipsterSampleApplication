...
describe('Service Tests', () => {
    ...
    describe('ContactApisSuffix Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(ContactApisSuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/contacts';
                expect(req.request.url).toEqual(resourceUrl + '/' + '123');
            });
            it('should return ContactApisSuffix', () => {
