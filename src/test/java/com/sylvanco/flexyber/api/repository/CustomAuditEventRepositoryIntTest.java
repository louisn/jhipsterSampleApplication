...
import com.sylvanco.flexyber.api.config.audit.AuditEventConverter;
import com.sylvanco.flexyber.api.domain.PersistentAuditEvent;
...
import static com.sylvanco.flexyber.api.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
