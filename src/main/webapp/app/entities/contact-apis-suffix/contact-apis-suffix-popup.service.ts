...
@Injectable()
export class ContactApisSuffixPopupService {
            ...
            if (id) {
                this.contactService.find(id)
                    .subscribe((contactResponse: HttpResponse<ContactApisSuffix>) => {
                        const contact: ContactApisSuffix = contactResponse.body;
                ...
                setTimeout(() => {
                    this.ngbModalRef = this.contactModalRef(component, new ContactApisSuffix());
                    resolve(this.ngbModalRef);
                }, 0);
            }
        });
    ...
    contactModalRef(component: Component, contact: ContactApisSuffix): NgbModalRef {
