package com.sylvanco.flexyber.api.config;
...
@Configuration
@EnableMongoRepositories("com.sylvanco.flexyber.api.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("com.sylvanco.flexyber.api.config.dbmigrations");
